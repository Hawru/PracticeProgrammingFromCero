document.addEventListener("DOMContentLoaded", (event) => {
    ...
    let icon_bar = document.querySelector(".menu-toggle__icon--1");
    let icon_xmark = document.querySelector(".menu-toggle__icon--2");
    ...
    button.addEventListener("click", (event) => {
        ...
        if(!visible){
            ...
            icon_bar.style.opacity = 0;
            icon_xmark.style.opacity = 1;
        } else{
           aside.classList.remove("layout__aside--visible");
           icon_bar.style.opacity = 1;
